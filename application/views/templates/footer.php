...
<script>
	$('#trigger-loading-1').on('click', function(e) {
		...
		//setTimeout(function() { $("#trigger-loading-1").removeClass("is-loading");}, 20000);
		//e.preventDefault();
	});
</script>
...
<script>
	$(document).ready(function(){
		$('.reorder_link').on('click',function(){
			...
			$('.reorder_link').html('Guardar Cambios');
			...
			$("#saveReorder").click(function( e ){
				if( !$("#saveReorder i").length ){
					$(this).html('').prepend('<img src="<?php echo base_url('assets/images/loading-gif.gif'); ?>" width="25"/>');
					...
					$.ajax({
						type: "POST",
						url: "<?php echo base_url('Content/orderUpdate'); ?>",
						data: {ids: " " + h + ""},
						success: function(){
